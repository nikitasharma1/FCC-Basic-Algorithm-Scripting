...
function reverseString(str) {
	...
	document.write(`String: <span class="bold">${ str }</span>, `);			//test output
	document.write(`Reverse: <span class="bold">${ newArr }</span><br>`);	//test output
...
function reverseString2(str) {
	...
	document.write(`String: <span class="bold">${ str }</span>, `);			//test output
	document.write(`Reverse: <span class="bold">${ newStr }</span><br>`);	//test output
